...
open_device( NodeProp& nodeprop )
{
  ...
  ////////// V1725
  {
    ...
    //{
      //{14670, 14670, 14530, 14570, 14680, 14730, 14720, 14780,
      //14700, 14740, 14730, 8145, 8210, 8210, 14700, 14700 }
    //};
    // 20250420
      {
       {14645, 14745, 14525, 14590, 14670, 14730, 14710, 14770,
	14675, 14715, 14745, 8145, 8210, 8210, 14700, 14700 }
      };
    ...
    //{
      ...
      //30, 30, 30, 30, 30, 30, 300, 300 }
      //};
      {
	{20, 20, 20, 20, 20, 20, 20, 20,
	 20, 20, 20, 20, 20, 20, 300, 300 }
      };
